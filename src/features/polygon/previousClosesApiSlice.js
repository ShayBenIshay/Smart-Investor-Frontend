...
import { polygonSmartInvestorApiSlice } from "../../app/api/polygonSmartInvestorApiSlice";

const previousClosesAdapter = createEntityAdapter({});

const initialState = previousClosesAdapter.getInitialState({});

export const previousClosesApiSlice =
  polygonSmartInvestorApiSlice.injectEndpoints({
    endpoints: (builder) => ({
      getPreviousCloses: builder.query({
        ...
        transformResponse: (responseData) => {
          ...
          return previousClosesAdapter.setAll(
            initialState,
            loadedPreviousCloses
          );
        },
